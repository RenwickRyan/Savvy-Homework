...
const user9data = info.filter(infos => infos.userId === 9);
// console.log(user9data);

const user9todos = user9data.filter(todos => todos.completed === true);
console.log("user 9 Complete todo's:", user9todos);

const user9todosIncomplete = user9data.filter(
  todoss => todoss.completed === false
);
console.log("User 9 Incomplete todo's:", user9todosIncomplete);

let countOfIncompletetodos = user9todosIncomplete.reduce(curr => curr + 1, 0);
console.log("Count of Incomplete Tasks:", countOfIncompletetodos - 1);
